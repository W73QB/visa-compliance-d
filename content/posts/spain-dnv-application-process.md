---
title: "Spain Digital Nomad Visa: application process & document checklist (2026)"
date: 2026-06-16
description: "Evidence-based walkthrough of the Spain Digital Nomad Visa application: the full document checklist, financial means, insurance rule, and processing timeline, sourced from the official BLS London consular checklist."
tags: ["spain", "dnv", "visa-process", "compliance"]
faq:
  - question: "What documents are required for the Spain Digital Nomad Visa?"
    answer: "The official BLS London checklist lists 14 items, including the application form, NIE, valid passport, criminal record certificate, proof of remote work for a foreign company, financial means, and health insurance from an insurer authorized in Spain."
  - question: "How much money do I need for the Spain Digital Nomad Visa?"
    answer: "The checklist requires financial means of at least 200% of the monthly Spanish minimum wage (SMI), which it states as EUR 1,134 per month for 2024, plus additional percentages per family member."
  - question: "How long does the Spain Digital Nomad Visa take?"
    answer: "The Consulate General of Spain in London states it should resolve applications within a maximum of 10 days, though this is the consular decision time, not the total end-to-end time."
  - question: "What insurance is required for the Spain Digital Nomad Visa?"
    answer: "Public or private health insurance from an insurance company authorized to operate in Spain, covering the risks of Spain's public health system, comprehensive, full and unlimited, with no excess, no co-payments and no waiting period."
---
...
This single rule disqualifies most international travel-medical policies. For the full evidence and which products meet it, see [Spain DNV insurance requirements](/posts/spain-dnv-insurance/) and [why travel policies get rejected](/posts/travel-vs-health-insurance-visa/).
