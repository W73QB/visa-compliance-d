...
**Route:** Residency Visa (Vistos / MFA)  
...
| --- | --- | --- | --- |
| `insurance.mandatory` | `==` | Yes | *Residency, General Documentation (applies to all residency visas, incl. people living from passive income / D7)*: "Valid travel insurance, covering necessary medical expenses, including urgent me..." ([source](/sources/PT_D7_VISTOS_2026-06-09.html)) |
| `insurance.must_cover_full_period` | `==` | Yes | *Residency, General Documentation (the residency visa requires valid travel insurance for the visa)*: "Valid travel insurance, covering necessary medical expenses, including urgent me..." ([source](/sources/PT_D7_VISTOS_2026-06-09.html)) |

## Source Documents

- **PT_D7_VISTOS_2026**: [Local copy](/sources/PT_D7_VISTOS_2026-06-09.html) | [Original](https://vistos.mne.gov.pt/en/national-visas/necessary-documentation/residency) | Retrieved: 2026-06-09

## Related reading

- [Portugal D7 visa insurance requirements](/posts/portugal-d7-insurance/)
...
The points below are taken directly from the official source for the Portugal D7 Visa (Passive Income) (Residency Visa (Vistos / MFA)) route. Each one is recorded with a source identifier and a locator so it can be traced back to the original document. Where the source is silent on a point, the engine records UNKNOWN instead of inferring an answer.
...
**What insurance does the Portugal D7 visa require?**  
The Ministry of Foreign Affairs requires valid travel insurance covering necessary medical expenses, including urgent medical assistance and possible repatriation, for the residency visa.

**Is a coverage amount such as 30,000 EUR stated officially?**  
No. The official residency-visa documentation states the cover scope (medical expenses, urgent assistance, repatriation) but no amount, so the engine does not use the secondary-source 30,000 EUR figure.

**Why is a monthly subscription marked YELLOW?**  
The insurance must be valid for the visa. A month-to-month policy that can lapse does not assure cover for the full period, so it is YELLOW; a full-period policy is GREEN.

## Check in the engine

Run a specific product against this route in the compliance checker: [Open Checker](/ui/?visa=PT_D7_VISTOS_2026&snapshot=2026-06-09). The checker shows the per-requirement outcome and the evidence behind each one.
...
- `insurance.mandatory` <- PT_D7_VISTOS_2026 (Residency, General Documentation (applies to all residency visas, incl. people living from passive income / D7)): "Valid travel insurance, covering necessary medical expenses, including urgent medical assistance and"
- `insurance.must_cover_full_period` <- PT_D7_VISTOS_2026 (Residency, General Documentation (the residency visa requires valid travel insurance for the visa)): "Valid travel insurance, covering necessary medical expenses, including urgent medical assistance and"


{{< checker_cta visa="PT_D7_VISTOS_2026" snapshot="2026-06-09" >}}
