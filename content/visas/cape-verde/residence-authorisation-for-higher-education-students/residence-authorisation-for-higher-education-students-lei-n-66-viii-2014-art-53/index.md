...
## Cape Verde Residence Authorisation for Higher-Education Students

**Route:** Residence authorisation for higher-education students (Lei n. 66/VIII/2014, art. 53)  
...
| --- | --- | --- | --- |
| `insurance.mandatory` | `==` | Yes | *Artigo 53, Autorizacao de residencia para estudantes do ensino superior*: "E concedida uma autorizacao de residencia ao estudante do ensino superior que: ...." ([source](/sources/CV_STUDENTRES_DGTCV_2026-06-16.pdf)) |

## Source Documents

- **CV_STUDENTRES_DGTCV_2026**: [Local copy](/sources/CV_STUDENTRES_DGTCV_2026-06-16.pdf) | [Original](https://dgtcv.gov.cv/index.php?Itemid=437&catid=15&id=33%3Alei-n-80-viii-2015-de-07-de-janeiro&m=0&option=com_jdownloads&task=download.send) | Retrieved: 2026-06-16

## Related reading

- [Cabo Verde student residence insurance requirements](/posts/cabo-verde-student-residence-insurance/)
- [What compliance statuses mean](/guides/compliance-status-meaning/)
- [How to read compliance results](/guides/how-to-read-results/)

## What the authority requires

The points below are taken directly from the official source for the Cape Verde Residence Authorisation for Higher-Education Students (Residence authorisation for higher-education students (Lei n. 66/VIII/2014, art. 53)) route. Each one is recorded with a source identifier and a locator so it can be traced back to the original document. Where the source is silent on a point, the engine records UNKNOWN instead of inferring an answer.
...
**What insurance does a Cabo Verde student residence require?**  
Cabo Verde's immigration law (Lei n. 66/VIII/2014, art. 53) requires a higher-education student applying for residence to have health insurance (seguro de saude).

**Is there a minimum amount or territory requirement?**  
The law lists health insurance with no coverage amount or territory, so the engine models only that insurance is mandatory.

**Which products show GREEN?**  
Because the only modeled requirement is that insurance is mandatory, every tracked product that provides health or travel insurance shows GREEN. Confirm the specific terms with the Cabo Verde authorities.

## Check in the engine

Run a specific product against this route in the compliance checker: [Open Checker](/ui/?visa=CV_STUDENTRES_DGTCV_2026&snapshot=2026-06-13). The checker shows the per-requirement outcome and the evidence behind each one.
...
- `insurance.mandatory` <- CV_STUDENTRES_DGTCV_2026 (Artigo 53, Autorizacao de residencia para estudantes do ensino superior): "E concedida uma autorizacao de residencia ao estudante do ensino superior que: ... d) Disponha de se"


{{< checker_cta visa="CV_STUDENTRES_DGTCV_2026" snapshot="2026-06-13" >}}
