...
**Route:** Digital Nomad Visa Category (Department of Immigration and Emigration)  
...
| --- | --- | --- | --- |
| `insurance.mandatory` | `==` | Yes | *Section 3, required documents, item X*: "International Health Insurance that covers medical care in Sri Lanka..." ([source](/sources/LK_DNV_IMMIGRATION_2026-06-15.pdf)) |
| `insurance.authorized_in_country` | `==` | Yes | *Section 3, required documents, item X*: "International Health Insurance that covers medical care in Sri Lanka..." ([source](/sources/LK_DNV_IMMIGRATION_2026-06-15.pdf)) |

## Source Documents

- **LK_DNV_IMMIGRATION_2026**: [Local copy](/sources/LK_DNV_IMMIGRATION_2026-06-15.pdf) | [Original](https://www.immigration.gov.lk/content/files/visa/digital_nomad/Digital%20Nomad%20Visa%20Category.pdf) | Retrieved: 2026-06-15

## Related reading

- [Sri Lanka Digital Nomad Visa insurance requirements](/posts/sri-lanka-dnv-insurance/)
- [Digital nomad insurance in Asia](/posts/digital-nomad-insurance-asia/)
- [How to read compliance results](/guides/how-to-read-results/)

## What the authority requires

The points below are taken directly from the official source for the Sri Lanka Digital Nomad Visa (Digital Nomad Visa Category (Department of Immigration and Emigration)) route. Each one is recorded with a source identifier and a locator so it can be traced back to the original document. Where the source is silent on a point, the engine records UNKNOWN instead of inferring an answer.
...
**What insurance does the Sri Lanka Digital Nomad Visa require?**  
The Department of Immigration and Emigration requires International Health Insurance that covers medical care in Sri Lanka, among the documents all applicants must submit.

**Why is only Genki Native GREEN for this route?**  
The policy must cover medical care in Sri Lanka. Genki Native documents global coverage that includes Sri Lanka; the other products do not document Sri Lanka validity, so the engine records UNKNOWN rather than assuming a foreign policy qualifies.

**Is there a minimum coverage amount?**  
The official document states no coverage amount, so the engine encodes none and models that insurance is mandatory and must cover medical care in Sri Lanka.

## Check in the engine

Run a specific product against this route in the compliance checker: [Open Checker](/ui/?visa=LK_DNV_IMMIGRATION_2026&snapshot=2026-06-13). The checker shows the per-requirement outcome and the evidence behind each one.
...
- `insurance.mandatory` <- LK_DNV_IMMIGRATION_2026 (Section 3, required documents, item X): "International Health Insurance that covers medical care in Sri Lanka"
- `insurance.authorized_in_country` <- LK_DNV_IMMIGRATION_2026 (Section 3, required documents, item X): "International Health Insurance that covers medical care in Sri Lanka"


{{< checker_cta visa="LK_DNV_IMMIGRATION_2026" snapshot="2026-06-13" >}}
