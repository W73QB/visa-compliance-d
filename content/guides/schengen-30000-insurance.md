...
faq:
  ...
  - question: "Does the policy need repatriation coverage?"
    answer: "Yes. EU Visa Code Article 15 requires repatriation coverage."
  - question: "Is this requirement the same as Spain DNV?"
    answer: "No. Spain DNV has stricter requirements such as unlimited coverage and no deductibles."
---
...
**Q: Does deductible matter?**
**A:** Some routes require zero deductible (for example, Spain DNV). Use the checker to confirm evidence for your route.

**Q: Does the policy need repatriation coverage?**
**A:** Yes. Article 15 explicitly requires repatriation coverage.

**Q: Is this requirement the same as Spain DNV?**
**A:** No. Spain DNV is stricter and requires unlimited coverage with no deductible or co-payments.

## Check in the engine

Use [the compliance checker](/ui/) with a route-specific snapshot. Example:
...
- [Spain coverage cap trap](/traps/spain-dnv-coverage-cap-trap/)
