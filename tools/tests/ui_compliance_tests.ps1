...
Assert-True ($ui -like '*for="visaSelect"*') "Visa select label has for attribute"
Assert-True ($ui -like '*for="productSelect"*') "Product select label has for attribute"
...
Assert-True ($ui -like '*rel="canonical" href="https://visafact.org/ui/"*') "UI has canonical URL for /ui/"
Assert-True ($ui -like '*property="og:url" content="https://visafact.org/ui/"*') "UI has og:url for /ui/"
Assert-True ($ui -like '*property="og:type" content="website"*') "UI has og:type website"
Assert-True ($ui -like '*property="og:image" content="https://visafact.org/images/og-default-1200x630.png"*') "UI has default og:image"
Assert-True ($ui -like '*name="twitter:card" content="summary_large_image"*') "UI has twitter card"
Assert-True ($ui -like '*name="twitter:image" content="https://visafact.org/images/og-default-1200x630.png"*') "UI has twitter:image"
